  ...
  return (
    <section className="panel p-5">
      <div className="border-b border-line pb-3">
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-stone-500">Reading History</p>
        <h3 className="mt-2 font-display text-2xl text-ink">Recently opened</h3>
      </div>

      <div className="mt-4 space-y-4">
        {historyItems.length === 0 ? (
          <div className="text-sm text-stone-500">Open an article to begin tracking your reading history.</div>
        ) : (
