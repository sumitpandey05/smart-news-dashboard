...
export default function Navbar({ query, setQuery, bookmarkCount }) {
  ...
  return (
    <header className="border-b border-line bg-paper">
      <div className="mx-auto max-w-7xl px-4 py-3 text-xs text-stone-600 sm:px-6 lg:px-8">
      ...
      <div className="border-y border-line bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-5 sm:px-6 lg:px-8">
          <button className="inline-flex items-center gap-2 text-sm font-medium text-stone-700 md:hidden">
          ...
          <Link to="/" className="text-center md:text-left">
            ...
            <p className="mt-1 text-xs uppercase tracking-[0.25em] text-stone-500">Smart News Intelligence</p>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <NavLink to="/bookmarks" className="inline-flex items-center gap-2 text-sm font-medium text-stone-700 hover:text-accent">
      ...
      <div className="border-b border-line bg-white">
        <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
          <div className="scrollbar-hide flex gap-6 overflow-x-auto text-sm font-medium text-stone-700">
            {navItems.map((item) => (
